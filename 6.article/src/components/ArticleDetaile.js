...
export default function ArticleDetaile() {
    return (
        <div>
            <PageHead />
            <div >
                <header className='mt-5 mx-auto' style={{ width: "50%" }}>
                    <p className='h1'>The most important lessons I’ve learned after a year of working with React</p>
                    <div className='mt-4'>
                        <Row>
                            <Col sm='12' md='12' lg='2' style={{ marginRight: -45 }}><Image src="https://miro.medium.com/fit/c/48/48/0*6IXk3RuAXJI_v-fk." roundedCircle /></Col>
                            <Col sm='12' md='6' lg='5' >
                                <Row>
                            ...
                            <Col sm='12' md='6' lg='5'><Button className="btn-sm" variant='outline-success' size='lg' block>Follow</Button></Col>
                        </Row>
                    </div>
                </header>
                <div className='mx-auto mt-5 mb-5'>
                    <Image style={{ width: '80%', marginLeft: '10%', marginRight: '10%' }} src="https://miro.medium.com/max/1434/1*TheYckj9udF4qLjoJW8sjg.png" />
                </div>
                <div className="mx-auto mb-5" style={{ width: '50%' }}>
                    ...
                    <p className='h4 text-left mt-2' style={{ textIndent: 30 }}>
                        ...
                        Make it so that if a new person jumps in, they won’t need days to understand how everything works.</p>
                </div>
                <FooterArticle />
