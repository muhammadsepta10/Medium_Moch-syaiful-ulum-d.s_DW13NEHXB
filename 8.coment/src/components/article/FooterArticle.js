      ...
      <div className="mx-auto mb-5" style={{ width: "50%" }}>
        ...
        <Row className="mt-5">
          ...
          <Col>
            <div style={{ float: "right" }} className="h4">
              <Link>
                <FaTwitter style={{ color: "black", margin: 10 }} />
              </Link>
              <Link>
                <FaFacebookSquare style={{ color: "black", margin: 10 }} />
              </Link>
              <Link>
                <FaBookmark style={{ color: "black", margin: 10 }} />
              </Link>
              <Link>
                <FaEllipsisH style={{ color: "black", margin: 10 }} />
              </Link>
            </div>
          </Col>
        </Row>
        <Row className="mb-5 mt-5 pt-5 border-top">
          <Col sm="12" md="12" lg="3" style={{ marginRight: -45 }}>
            <Image
              style={{ width: "50%" }}
              src="https://miro.medium.com/fit/c/160/160/0*6IXk3RuAXJI_v-fk."
              roundedCircle
            />
          </Col>
          <Col sm="12" md="6" lg="5">
        ...
        <Row className="mb-5 mt-5 pb-5 border-bottom">
          <Col sm="12" md="12" lg="3" style={{ marginRight: -45 }}>
            <Image
              style={{ width: "50%" }}
              src="https://miro.medium.com/fit/c/160/160/1*MotlWcSa2n6FrOx3ul89kw.png"
              rounded
            />
          </Col>
          <Col sm="12" md="6" lg="5">
