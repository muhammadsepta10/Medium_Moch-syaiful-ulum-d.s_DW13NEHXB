...
const articleBottoms = [
  {
    ...
    content:
      "Instead of looking for traits to emulate, focus on ones to avoid Darius Foroux in Forge",
    name: "jhon",
        ...
        <div style={{ marginRight: 100, marginLeft: 100 }}>
          <Row>
            <Col>
              <a href="">
                <Image
                  src="https://miro.medium.com/max/5472/1*8yz3hkO3ynHV2qYGARynJg.jpeg"
              ...
              <div className="mt-3 text-left" style={{ marginLeft: 100 }}>
                ...
                <p>
                  ...
                  finibus vitae erat scelerisque pretium.
                </p>
                <br />
                <p>
                  <a>Darius Faroux in Forge</a>
                  <br />
                  <small>jul 9 . 5 min read</small>
                </p>
              </div>
            </Col>
            ...
            <Col>
              <Col>
                <a href="">
                  <Image
                    src="https://miro.medium.com/max/590/1*cBFSQ9Ytv_D0jwGtpuL5WA.png"
                    style={{
                      width: 250,
                      height: 150,
                      float: "right",
                ...
                <div className="mt-3 text-left" style={{ marginLeft: 65 }}>
                  ...
                  <p>
                    ...
                    Nunc finibus vitae erat scelerisque pretium.
                  </p>
                  <br />
