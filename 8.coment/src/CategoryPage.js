        ...
        <Container className="mt-5 mb-5">
          <Row className="mx-auto">
            ...
            <Col sm="5">
              <p
                className="h5"
                style={{ width: 350, fontFamily: "sans-serif" }}
              >
                <div style={{ color: "#6A0BFF" }}>
                  The fron lines of the fitire.
                </div>{" "}
          ...
          <Row className="bg-primary mt-5">
            ...
            >
              <div className="text-center">
                ...
                <p
                  className="h6"
                  style={{ fontFamily: "sans-serif", color: "#D3F832" }}
                >
                  ian Frisc
                </p>
                <p
          ...
          <Row className="mt-5">
            <Col sm="12" lg="4" md="4" style={{ margin: "auto" }}>
              <div className="text-center">
                ...
                <p className="h5" style={{ fontFamily: "sans-serif" }}>
                  Lorem Ipsum dolor sit amet
                </p>
                <br />
                <p
                  className="h6"
                  style={{ fontFamily: "sans-serif", color: "#6A0BFF" }}
                >
                  ian Frisc
                </p>
                <p className="h6" style={{ fontFamily: "sans-serif" }}>
                  Dec . 24 min read
                </p>
              </div>
            </Col>
          ...
          <div
            className="border-top border-info mt-5 mx-auto"
          ...
          {article.map(item => (
            <Row
              className="border-bottom border-info mt-5 mx-auto"
              style={{ width: "50%" }}
            >
